...
class SecondChildRecyclerViewAdapter(val context: Context, val items: MutableList<BoardModel>, val keyList: MutableList<String>) : RecyclerView.Adapter<SecondChildRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SecondChildRecyclerViewAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.boarditem,parent,false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: SecondChildRecyclerViewAdapter.ViewHolder, position: Int) {
