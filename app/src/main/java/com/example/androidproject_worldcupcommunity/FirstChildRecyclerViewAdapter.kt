...
class FirstChildRecyclerViewAdapter(val context: Context, val items: MutableList<BoardModel>, val keyList: MutableList<String>) : RecyclerView.Adapter<FirstChildRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FirstChildRecyclerViewAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.boarditem,parent,false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: FirstChildRecyclerViewAdapter.ViewHolder, position: Int) {
