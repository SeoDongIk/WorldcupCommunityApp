...
class SecondChildFragment : Fragment() {
    ...
    private lateinit var binding : FragmentSecondChildBinding
    private lateinit var secondChildRecyclerAdapter : SecondChildRecyclerViewAdapter
    ...
    override fun onCreateView(
        ...
        val postListener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for(dataModel in snapshot.children){
                    ...
                    if(item!!.category == "두번째 게시판"){
                        boardList.add(item!!)
                        boardKeyList.add(key)
                    }
                }
                secondChildRecyclerAdapter.notifyDataSetChanged()
            }
        ...
        secondChildRecyclerAdapter = SecondChildRecyclerViewAdapter(requireContext(), boardList.asReversed(), boardKeyList.asReversed())
        recyclerview?.adapter = secondChildRecyclerAdapter
